                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="portlet box green">
                            ...
                            try {
                                // Fetch data from the marketing_tag table
                                $query = $conn->prepare("SELECT * FROM marketing_tag ORDER BY id DESC");
                                $query->execute();
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if (!empty($tag['image'])): ?>
                                                            <img src="../pages/uploads/marketing_tag/<?php echo $tag['image']; ?>" width="50" height="50" alt="Tag Image">
                                                        <?php else: ?>
                                                            No Image
                                                        <?php endif; ?>
                                                    </td>
                                                    <td><?php echo htmlspecialchars($tag['title']); ?></td>
                                                    <td><?php echo htmlspecialchars($tag['priority']); ?></td>
                                                    <td style="display: flex; justify-content: center; align-items: center; gap: 15px;">
                                                        <!-- Edit Button -->
                                                        <a style="color:black; padding: 10px;" href="./marketing_tag_update.php?id=<?php echo $tag['id']; ?>">
                                                            <span style="font-size: 1.5em;" class="glyphicon glyphicon-pencil"></span>
                                                        </a>

                                                        <!-- Delete Button -->
                                                        <a style="padding: 10px;" href="./marketing_tag_delete.php?id=<?php echo $tag['id']; ?>"
