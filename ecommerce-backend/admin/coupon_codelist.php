                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box green">
                            <div class="portlet-title">
                                ...
                                <a class="dt-button buttons-print btn default" style="margin-left: 2%; margin-top: 0.4%;" href="./coupon_code_add.php">ADD Coupon</a>
                            </div>
                            <div class="portlet-body">
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        $query = $pdo->prepare("SELECT * from coupons");
                                        $query->execute();
                                        ...
                                        foreach ($brand as $std) {
                                            ...
                                            echo '<td>' . $std['date_from'] . '</td>';
                                            echo '<td>' . $std['date_to'] . '</td>';
                                            echo '<td>' . $std['type'] . '</td>';
                                            echo '<td>' . $std['coupon_type'] . '</td>';
                                            echo '<td>' . $std['coupon_value'] . '</td>';
                                            echo '<td>' . $std['min_bill_amount'] . '</td>';
                                            echo '<td>' . $std['max_discount'] . '</td>';
                                            echo '<td style="display: flex; justify-content: center; align-items: center; gap: 15px;">
                                            <!-- Update Button -->
                                            <a style="color:black; padding: 10px;" href="./coupon_code_update.php?id=' . $std["id"] . '">
                                                <span style="font-size: 1.5em;" class="glyphicon glyphicon-pencil"></span> 
                                            </a>
                                    
                                            <!-- Delete Button -->
                                            <a style="padding: 10px;" href="./coupon_code_delete.php?id=' . $std["id"] . '" 
