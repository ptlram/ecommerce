                            ...
                            <div class="portlet-body">
                                <table class="table table-striped table-bordered table-hover" id="sample_2">
                                    ...
                                    <tbody>
                                        ...
                                        $query = $conn->prepare("SELECT * FROM time_slot ORDER BY priority ASC");
                                        $query->execute();
                                        ...
                                        foreach ($time_slots as $slot) {
                                            ...
                                            echo "<td>" . htmlspecialchars($slot['time_slot']) . "</td>";
                                            echo "<td>" . htmlspecialchars($slot['priority']) . "</td>";
                                            echo "<td style='display: flex; justify-content: center; align-items: center; gap: 15px;'>";

                                            // Edit Button
                                            echo "<a style='color:black; padding: 10px;' href='./delivery_time_slot_update.php?id=" . $slot["id"] . "'>
                                                    <span style='font-size: 1.5em;' class='glyphicon glyphicon-pencil'></span> 
                                                </a>";

                                            // Delete Button
                                            echo "<a style='padding: 10px;' href='./delivery_time_slot_delete.php?id=" . $slot["id"] . "' 
