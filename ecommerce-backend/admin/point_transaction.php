                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box green">
                            <div class="portlet-title">
                                <div class="caption">Point Transaction</div>
                                <a class="dt-button buttons-print btn default" style="margin-left: 2%; margin-top: 0.4%;" href="./point_transaction_add.php"> Add Transaction </a>
                            </div>
