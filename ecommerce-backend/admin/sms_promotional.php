                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box green">
                            <div class="portlet-title">
                                <div class="caption">SMS List</div>
                                <a class="dt-button buttons-print btn default" style="margin-left: 2%; margin-top: 0.4%;" href="./sms_promotional_add.php"> Add Promotional SMS</a>
                            </div>
