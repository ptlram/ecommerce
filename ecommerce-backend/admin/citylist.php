                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box green">
                            <div class="portlet-title">
                                <div class="caption"><i class="fa fa-globe"></i>CITY LIST</div>
                                <div class="tools"></div>
                            </div>
                            <div class="portlet-body">
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        $students = $pdo->prepare("select * from cities");
                                        $students->execute();
                                        ...
                                        foreach ($student as $std) {
                                            ...
                                            echo '<td>' . $std['state_id'] . '</td>';
                                            echo '<td style="display: flex; justify-content: center; align-items: center; gap: 15px;">
                                            <a style="color:black;padding: 10px;" href="./updatecity.php?id=' . $std["id"] . '""><span style="font-size: 1.5em;" class="glyphicon glyphicon-pencil"> </span> </a>
                                            <a style="padding: 10px;"  href="../pages/delete_city.php?id=' . $std["id"] . '" onclick="return confirm(\'Are you sure you want to delete this student and all associated images?\');"><span style="font-size: 1.5em;" class="glyphicon glyphicon-trash"></span></a></td>';
                                            echo '</tr>';
                                        }
