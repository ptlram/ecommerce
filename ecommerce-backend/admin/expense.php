                            ...
                            <div class="portlet-body">
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        $query = $conn->prepare('SELECT * FROM expense ');
                                        $query->execute();
                                        ...
                                        foreach ($expenses as $expense) {
                                            ...
                                            <a style="color:black; padding: 10px;" href="./expense_update.php?id=' . $expense["id"] . '">
                                                <span style="font-size: 1.5em;" class="glyphicon glyphicon-pencil"></span> 
                                            </a>
                                    
                                            <!-- Delete Button -->
                                            <a style="padding: 10px;" href="./expense_delete.php?id=' . $expense["id"] . '" 
