                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box green">
                            <div class="portlet-title">
                                ...
                                <a class="dt-button buttons-print btn default" style="margin-left: 2%; margin-top: 0.4%;" href="./sub_categoryadd.php">ADD SUB CATAGORY</a>
                            </div>
                            <div class="portlet-body">
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        $query = $pdo->prepare("SELECT * from subcategory");
                                        $query->execute();
                                        ...
                                        foreach ($brand as $std) {
                                            echo '<tr>';
                                            echo '<td>' . $std['id'] . '</td>';
                                            echo '<td><img src="../pages/uploads/subcategory/' . $std['image'] . '" width="50" height="50" alt="default"></td>';
                                            echo '<td>' . $std['name'] . '</td>';
                                            $cid = $std['category_id'];
                                            ...
                                            <!-- Update Button -->
                                            <a style="color:black; padding: 10px;" href="./sub_categoryupdate.php?id=' . $std["id"] . '">
                                                <span style="font-size: 1.5em;" class="glyphicon glyphicon-pencil"></span> 
                                            </a>
                                    
                                            <!-- Delete Button -->
                                            <a style="padding: 10px;" href="./sub_categorydelete.php?id=' . $std["id"] . '" 
