                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box green">
                            <div class="portlet-title">
                                ...
                                <a class="dt-button buttons-print btn default" style="margin-left: 2%; margin-top: 0.4%;" href="./customeradd.php">ADD CUSTOMER</a>
                            </div>
                                ...
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($brand as $std) {
                                            ...
                                            echo '<td>' . $std['id'] . '</td>';
                                            echo '<td>' . $std['name'] . '</td>';
                                            echo '<td>' . $std['mobile_number'] . '</td>';
                                            echo '<td>' . $std['points'] . '</td>';
                                            echo '<td>' . $std['email'] . '</td>';
                                            echo '<td>' . $std['address'] . '</td>';
                                            echo '<td>' . $std['customer_type'] . '</td>';
                                            echo '<td>' . $std['gst_number'] . '</td>';
                                            echo '<td>' . $std['gst_number'] . '</td>';
                                            echo '<td>' . $std['gst_number'] . '</td>';
                                            echo '<td>' . $std['ReferralCode'] . '</td>';
                                            echo '<td style="display: flex; justify-content: center; align-items: center; gap: 15px;">
                                            <!-- Update Button -->
                                            <a style="color:black; padding: 10px;" href="./customerupdate.php?id=' . $std["id"] . '">
                                                <span style="font-size: 1.5em;" class="glyphicon glyphicon-pencil"></span> 
                                            </a>
                                    
                                            <!-- Delete Button -->
                                            <a style="padding: 10px;" href="./customerdelete.php?id=' . $std["id"] . '" 
