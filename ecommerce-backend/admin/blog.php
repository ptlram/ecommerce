                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-body">
                                ...
                                $sql = "SELECT id, blog_title, blog_image, short_description, blog_date FROM blogs ORDER BY blog_date DESC";
                                    ...
                                    <tbody>
                                        <?php foreach ($blogs as $blog) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="../pages/uploads/blog/<?php echo htmlspecialchars($blog['blog_image']); ?>" width="100" alt="Blog Image">
                                                </td>
                                                <td><?php echo htmlspecialchars($blog['short_description']); ?></td>
                                                <td><?php echo date("d-M-Y", strtotime($blog['blog_date'])); ?></td>
                                                <td style="display: flex; justify-content: center; align-items: center; gap: 15px;">
                                                    <!-- Update Button -->
                                                    <a style="color:black; padding: 10px;" href="./blog_update.php?id=<?php echo $blog['id']; ?>">
                                                        <span style="font-size: 1.5em;" class="glyphicon glyphicon-pencil"></span>
                                                    </a>

                                                    <!-- Delete Button -->
                                                    <a style="padding: 10px;" href="./blog_delete.php?id=<?php echo $blog['id']; ?>"
