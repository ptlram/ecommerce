                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box green">
                            <div class="portlet-title">
                                <div class="caption">CATAGORY LIST</div>
                                <a class="dt-button buttons-print btn default" style="margin-left: 2%; margin-top: 0.4%;" href="./categoryadd.php">ADD CATAGORY</a>
                            </div>
                                ...
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($brand as $std) {
                                            echo '<tr>';
                                            echo '<td>' . $std['id'] . '</td>';
                                            echo '<td><img src="../pages/uploads/category/' . $std['image'] . '" width="50" height="50" alt="default"></td>';
                                            echo '<td><img src="../pages/uploads/category/' . $std['banner'] . '" width="50" height="50" alt="default"></td>';
                                            echo '<td>' . $std['name'] . '</td>';
                                            ...
                                            <!-- Update Button -->
                                            <a style="color:black; padding: 10px;" href="./categoryupdate.php?id=' . $std["id"] . '">
                                                <span style="font-size: 1.5em;" class="glyphicon glyphicon-pencil"></span> 
                                            </a>
                                    
                                            <!-- Delete Button -->
                                            <a style="padding: 10px;" href="./categorydelete.php?id=' . $std["id"] . '" 
