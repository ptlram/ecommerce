  ...
  var handleTheme = function () {
    ...
    var setLayout = function () {
      ...
      if (sidebarOption == "fixed" && headerOption == "default") {
        alert(
          "Default Header with Fixed user option is not supported. Proceed with Fixed Header with Fixed user."
        );
        $(".page-header-option", panel).val("fixed");
      ...
      if ($("body").hasClass("page-full-width") === false) {
        if (sidebarOption === "fixed") {
          ...
          Layout.initFixeduserHoverEffect();
        } else {
      ...
      if (sidebarMenuOption === "hover") {
        if (sidebarOption == "fixed") {
          ...
          alert(
            "Hover user Menu is not compatible with Fixed user Mode. Select Default user Mode Instead."
          );
        } else {
      ...
      Layout.initFixeduser(); // reinitialize fixed sidebar
    };
