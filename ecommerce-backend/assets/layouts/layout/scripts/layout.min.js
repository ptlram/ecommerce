var Layout = (function () {
        ...
        if (s.hasClass("page-sidebar-fixed"))
          ...
          (e =
            App.getViewPort().width < t
              ? App.getViewPort().height - r - d
              : i.height() + 20),
            e + r + d <= App.getViewPort().height &&
              (e = App.getViewPort().height - r - d);
        }
        a.css("min-height", e);
      }
    },
      ...
      $("body").on("click", ".sidebar-toggler", function (e) {
        ...
        $(".sidebar-search", t).removeClass("open"),
          a.hasClass("page-sidebar-closed")
            ? (a.removeClass("page-sidebar-closed"),
          ...
          App.destroySlimScroll(i.find(".full-height-content-body")),
            ...
            a.hasClass("full-height-content-scrollable")
              ? ((e -= 35),
                ...
                App.initSlimScroll(i.find(".full-height-content-body")))
              : i.css("min-height", e);
  ...
  return {
    ...
    setAngularJsuserMenuActiveLink: function (e, a, t) {
      n(e, a, t);
    },
    inituser: function (e) {
      d(),
