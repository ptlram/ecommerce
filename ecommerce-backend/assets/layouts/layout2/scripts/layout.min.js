var Layout = (function () {
  var e = "layouts/layout2/img/",
        ...
        if (s.hasClass("page-sidebar-fixed"))
          ...
          (e =
            App.getViewPort().width < i
              ? App.getViewPort().height - n - r
              : t.height() + 20),
            e + n + r <= App.getViewPort().height &&
              (e = App.getViewPort().height - n - r);
        }
        a.css("min-height", e);
      }
    },
            ...
            o.find("li > a").each(function () {
              ...
              if (t && e) {
                ...
                if (
                  i &&
                  ((i = i.toLowerCase()),
                  i.length > 1 && s.substr(1, i.length - 1) == i.substr(1))
                )
                  return void (a = $(this));
              }
            }),
        ...
        function (e) {
          ...
          if (
            !(
              ...
              1 === a.parent("li").parent(".page-sidebar-menu").size()
            )
          ) {
                  ...
                  l.slideUp(p, function () {
                    d === !0 &&
                      ...
                      ($("body").hasClass("page-sidebar-fixed")
                        ? r.slimScroll({ scrollTo: n.position().top })
                        : App.scrollTo(n, h)),
                      o();
                  }))
                : t &&
    ...
    p = function () {
      ...
      return (
        ...
        0 === $(".page-sidebar-fixed").size()
          ...
          : void (
              App.getViewPort().width >= i &&
              (e.attr("data-height", d()), App.initSlimScroll(e), o())
            )
      );
    },
    c = function () {
        ...
        $(".sidebar-search", i).removeClass("open"),
          e.hasClass("page-sidebar-closed")
            ? (e.removeClass("page-sidebar-closed"),
              t.removeClass("page-sidebar-menu-closed"),
              Cookies && Cookies.set("sidebar_closed", "0"))
            : (e.addClass("page-sidebar-closed"),
              t.addClass("page-sidebar-menu-closed"),
              e.hasClass("page-sidebar-fixed") && t.trigger("mouseleave"),
    ...
    g = function () {
      ...
      navigator.userAgent.match(/iPhone|iPad|iPod/i)
        ? $(window).bind("touchend touchcancel touchleave", function (i) {
            $(this).scrollTop() > e
  ...
  return {
    ...
    setuserMenuActiveLink: function (e, a) {
      n(e, a);
    },
    setAngularJsuserMenuActiveLink: function (e, a, i) {
      n(e, a, i);
    },
    inituser: function (e) {
      p(),
    ...
    init: function () {
      this.initHeader(), this.inituser(), this.initContent(), this.initFooter();
    },
