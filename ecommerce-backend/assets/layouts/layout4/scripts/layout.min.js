var Layout = (function () {
        ...
        if (t.hasClass("page-sidebar-fixed"))
          ...
          (e =
            App.getViewPort().width < s
              ? App.getViewPort().height - n - d
              : i.height() + 20),
            e + n + d <= App.getViewPort().height &&
              (e = App.getViewPort().height - n - d);
        }
        a.css("min-height", e);
      }
    },
              ...
              r.slideUp(l, function () {
                n === !0 &&
                  ...
                  ($("body").hasClass("page-sidebar-fixed")
                    ? t.slimScroll({ scrollTo: i.position().top })
                    : App.scrollTo(i, p)),
                  o();
              }))
  ...
  return {
    ...
    setAngularJsuserMenuActiveLink: function (e, a, s) {
      r(e, a, s);
    },
    inituser: function (e) {
      d(),
